...
function Bio(){
    return (
        ...
        <div>
            ...
            <Button className="text-center" id="skill-button">
                <Modal.Dialog>
                    <Modal.Header closeButton>
                        <Modal.Title id="skill-text">Modal title</Modal.Title>
                    </Modal.Header>
            ...
            {/* <Card className="text-center" id="skill-card" active>
                <Card.Body>
                    <Card.Title id="skill-text">Skills</Card.Title>
